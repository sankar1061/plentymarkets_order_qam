...
class NovalnetPrzelewyPaymentMethod extends PaymentMethodService
{
    ...
    {   
        if(empty($name = trim($this->configRepository->get('Novalnet.novalnet_przelewy_payment_name'))))
        {
    ...
    {
        if(empty($description = trim($this->configRepository->get('Novalnet.novalnet_przelewy_description'))))
        {
